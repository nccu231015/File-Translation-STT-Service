...
// Types moved inside to avoid separate API file for mock feature
...
// Mock implementation directly in component
const generateReport = async (type: string, timeRange: string): Promise<ReportData> => {
