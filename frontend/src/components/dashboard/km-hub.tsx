...
export function KMHub() {
    ...
    return (
        <div className="h-full">
            {/* ── Landing ─────────────────────────────────────────────────── */}
            <div className={subView === 'landing' ? 'flex flex-col items-center justify-center min-h-[60vh] gap-10 px-4' : 'hidden'}>
                {/* Header */}
            ...
            {/* ── Factory Q&A — stays mounted to preserve in-flight state ── */}
            <div className={subView === 'factory' ? 'flex flex-col gap-3 h-full' : 'hidden'}>
                <Button
                    variant="ghost"
                    size="sm"
            ...
            {/* ── Doc Q&A — stays mounted to preserve in-flight state ─────── */}
            <div className={subView === 'doc' ? 'flex flex-col gap-3 h-full' : 'hidden'}>
                <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => setSubView('landing')}
