...
3. **專業數據解說**：在表格下方提供一段具建設性的專業文字解說。**不須使用「亮點」、「風險」或「建議」等固定標題段落**，而是以連貫的專業語言闡述目前的數據現狀（例如：達成率分布、產能狀態等）。"""
    ...
    def _analyze_chunk(self, text: str, final: bool = False, is_reduce_step: bool = False) -> dict:
        ...
        if is_reduce_step:
            prompt = (
                "You are an expert bilingual meeting secretary. Compile a FINAL, HIGHLY DETAILED meeting minute.\n\n"
                "Context: Meeting between 業主方 (Client) and PM方 (PM Team).\n\n"
                "Output a single JSON with BOTH Traditional Chinese (zh_*) and English (en_*) fields:\n"
                "{\n"
                "  \"attendees\": \"string (Chinese)\",\n"
                "  \"meeting_objective\": \"DETAILED - Traditional Chinese\",\n"
                "  \"en_meeting_objective\": \"DETAILED - English translation\",\n"
                "  \"discussion_summary\": \"VERY LONG comprehensive summary - Traditional Chinese\",\n"
                "  \"en_discussion_summary\": \"VERY LONG comprehensive summary - English translation\",\n"
                "  \"schedule_notes\": \"Traditional Chinese\",\n"
                "  \"en_schedule_notes\": \"English\",\n"
                "  \"decisions\": [\"Decision in Traditional Chinese\"],\n"
                "  \"en_decisions\": [\"Decision in English\"],\n"
                "  \"action_items\": [{\"task\": \"Chinese\", \"owner\": \"Chinese\", \"deadline\": \"Date\"}],\n"
                "  \"en_action_items\": [{\"task\": \"English\", \"owner\": \"English\", \"deadline\": \"Date\"}]\n"
                "}\n\n"
                "Rules:\n"
                "- zh_* fields: Traditional Chinese (Taiwan) ONLY.\n"
                "- en_* fields: English ONLY.\n"
                "- BE VERBOSE: detailed report, not a brief summary.\n"
                "- Output ONLY valid JSON."
            )
        else:
            prompt = (
                "You are an expert bilingual meeting secretary. Analyze this meeting transcript segment.\n\n"
                "Context: Meeting between 業主方 (Client) and PM方 (PM Team).\n\n"
                "Output JSON with BOTH Traditional Chinese (zh_*) and English (en_*) fields:\n"
                "{\n"
                "  \"attendees\": \"Names (if mentioned)\",\n"
                "  \"meeting_objective\": \"Purpose - Traditional Chinese\",\n"
                "  \"en_meeting_objective\": \"Purpose - English\",\n"
                "  \"discussion_summary\": \"Detailed summary - Traditional Chinese\",\n"
                "  \"en_discussion_summary\": \"Detailed summary - English\",\n"
                "  \"schedule_notes\": \"Traditional Chinese\",\n"
                "  \"en_schedule_notes\": \"English\",\n"
                "  \"decisions\": [\"Decision - Chinese\"],\n"
                "  \"en_decisions\": [\"Decision - English\"],\n"
                "  \"action_items\": [{\"task\": \"Chinese\", \"owner\": \"Chinese\", \"deadline\": \"Due\"}],\n"
                "  \"en_action_items\": [{\"task\": \"English\", \"owner\": \"English\", \"deadline\": \"Due\"}]\n"
                "}\n\n"
                "Rules:\n"
                "- Output ONLY valid JSON."
            )
